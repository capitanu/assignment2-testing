...
public final class Preconditions {
     ...
     *             if the condition to check is false
     */
     ...
     * @param b
     *            right boundary of the interval (inclusive)
     * 
     * @return the value if it is contained [a, b]
     * 
     * @throws IllegalArgumentException
     *             if value isn't contained in interval
     */
    public static int checkInInterval(int value, int a, int b) {
